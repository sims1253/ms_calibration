...
p_rmse_log_showcase
ggsave(paste0(figure_path,"positive_rmse_log_showcase.pdf"), width = 210, height = (297/4)*1.6, units = "mm", useDingbats = TRUE)

# RMSE log pointrange showcase
scales <- list(
...
m1 = brm(auc ~ 1 +
         ...
         data = df, family = Beta(), cores = 4, warmup = 1000, iter = 3500,file = paste0(data_path, "m1.RDS"))
summary(m1)
