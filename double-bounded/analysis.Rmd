...
p_rmse_showcase
ggsave(paste0(figure_path,"unit_rmse_showcase.pdf"), width = 210, height = (297/4)*1.2, units = "mm", useDingbats = TRUE)
...
p0 = conditional_effects(m1, effects = "fit_link_transformed:data_link_transformed",
...
plot(p0, plot = FALSE)[[1]] + scale_color_scico_d(palette = "batlow", end = 0.8)
